...
## Week of January 23
The goal of this week is to run the franka panda simulations via drake and run libfranka built-in examples on simulation and hardware. The franka-drake driver I will be using will be from https://github.com/KhachDavid/franka_drake.git 
